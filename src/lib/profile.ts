...
/** Routes of the candidate designs, in switcher order (4 = the original pre-comic site, 5 = its refined version). */
export const OPTION_HREFS = [1, 2, 3, 4, 5].map((n) => `/options/${n}`);
